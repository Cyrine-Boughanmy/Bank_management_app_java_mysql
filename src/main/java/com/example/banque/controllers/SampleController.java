...
import com.example.banque.HelloApplication;
import com.example.banque.models.Employe;
...
public class SampleController implements Initializable {
    ...
    public void update() {
        String qr = "UPDATE Employe SET  CodeEmploye='" + tcode.getText() + "', NomEmploye='" + tnom.getText() + "',PrenomEmploye='" + tprenom.getText() + "',Adresse='" + tadr.getText() + "'";
    ...
    public void delete() {
        String qr = "DELETE FROM Employe WHERE CodeClient= " + tcode.getText() + "";
        executeQuery(qr);
        showEmployes();
    }
    ...
    void retour(ActionEvent e) throws IOException {
       ...
       /*HelloApplication m = new HelloApplication();
        m.ChangeScene("views/accueil.fxml");*/
    }
