...
import com.example.banque.models.Compte;
import com.example.banque.models.Virement;
...
public class VirementController implements Initializable {
    ...
    @FXML
    public void clictv(MouseEvent event) {
        ...
        tidce.setText("" + virement.getIdCompteRec());
