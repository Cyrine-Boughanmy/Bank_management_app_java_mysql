...
import com.example.banque.models.Client;
...
public class ClientController implements Initializable {
    ...
    public void update() {
        String qr = "UPDATE Client SET  CodeClient='" + tcl.getText() + "', NomClient='" + tncl.getText() + "',PrenomClient='" + tpcl.getText() + "',AdresseClient='" + tacl.getText() + "'";
        executeQuery(qr);
        showClients();
    }
